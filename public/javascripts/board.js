...
var _WinterTechForum$open_spaces_board$Board$Topic = F2(
	function (a, b) {
		return {text: a, convener: b};
	});
var _WinterTechForum$open_spaces_board$Board$topicDecoder = A3(
...
var _WinterTechForum$open_spaces_board$Board$dataManipulationDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_WinterTechForum$open_spaces_board$Board$DataManipulation,
	...
	A2(
		...
		function (opCode) {
			var _p0 = opCode;
			if (_p0 === '+') {
				return _WinterTechForum$open_spaces_board$Board$Add;
			} else {
				return _WinterTechForum$open_spaces_board$Board$Remove;
			}
		},
...
var _WinterTechForum$open_spaces_board$Board$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'WebSocketMessage':
				var dataManipulationsRes = A2(
					_elm_lang$core$Json_Decode$decodeString,
					_elm_lang$core$Json_Decode$list(_WinterTechForum$open_spaces_board$Board$dataManipulationDecoder),
					_p1._0);
				return {
					ctor: '_Tuple2',
					_0: function () {
						...
						if (_p2.ctor === 'Ok') {
							return A3(
								_elm_lang$core$List$foldr,
								F2(
									function (dataManipulation, accumModel) {
										...
										switch (_p3) {
											case '*':
												...
												if (_p4.ctor === 'Add') {
													...
													return _elm_lang$core$Native_Utils.update(
														accumModel,
														{rooms: _elm_lang$core$Set$empty, timeSlots: _elm_lang$core$Set$empty, topicIdsByTimeSlotRoom: _elm_lang$core$Dict$empty, topicsById: _elm_lang$core$Dict$empty, timeSlotRoomsByTopicId: _elm_lang$core$Dict$empty});
												}
											case 'timeSlot':
												...
												if (_p5.ctor === 'Add') {
													return _elm_lang$core$Native_Utils.update(
														accumModel,
														{
															timeSlots: A2(_elm_lang$core$Set$insert, dataManipulation.key, accumModel.timeSlots)
														});
												} else {
													return _elm_lang$core$Native_Utils.update(
														accumModel,
														{
															timeSlots: A2(_elm_lang$core$Set$remove, dataManipulation.key, accumModel.timeSlots),
															topicIdsByTimeSlotRoom: A2(
																_elm_lang$core$Dict$filter,
																F2(
																	function (_p7, _p6) {
																		var _p8 = _p7;
																		return !_elm_lang$core$Native_Utils.eq(_p8._0, dataManipulation.key);
																	}),
																accumModel.topicIdsByTimeSlotRoom),
															timeSlotRoomsByTopicId: A2(
																_elm_lang$core$Dict$filter,
																F2(
																	function (_p10, _p9) {
																		var _p11 = _p9;
																		return !_elm_lang$core$Native_Utils.eq(_p11._0, dataManipulation.key);
																	}),
																accumModel.timeSlotRoomsByTopicId)
														});
												}
											case 'room':
												var _p12 = dataManipulation.operation;
												if (_p12.ctor === 'Add') {
													return _elm_lang$core$Native_Utils.update(
														accumModel,
														{
															rooms: A2(_elm_lang$core$Set$insert, dataManipulation.key, accumModel.rooms)
														});
												} else {
													return _elm_lang$core$Native_Utils.update(
														accumModel,
														{
															rooms: A2(_elm_lang$core$Set$remove, dataManipulation.key, accumModel.rooms),
															topicIdsByTimeSlotRoom: A2(
																_elm_lang$core$Dict$filter,
																F2(
																	function (_p14, _p13) {
																		var _p15 = _p14;
																		return !_elm_lang$core$Native_Utils.eq(_p15._1, dataManipulation.key);
																	}),
																accumModel.topicIdsByTimeSlotRoom),
															timeSlotRoomsByTopicId: A2(
																_elm_lang$core$Dict$filter,
																F2(
																	function (_p17, _p16) {
																		var _p18 = _p16;
																		return !_elm_lang$core$Native_Utils.eq(_p18._1, dataManipulation.key);
																	}),
																accumModel.timeSlotRoomsByTopicId)
														});
												}
											case 'topic':
												var _p19 = dataManipulation.operation;
												if (_p19.ctor === 'Add') {
													var _p20 = dataManipulation.value;
													if (_p20.ctor === 'Just') {
														var _p21 = A2(_elm_lang$core$Json_Decode$decodeValue, _WinterTechForum$open_spaces_board$Board$topicDecoder, _p20._0);
														if (_p21.ctor === 'Ok') {
															return _elm_lang$core$Native_Utils.update(
																accumModel,
																{
													...
													return _elm_lang$core$Native_Utils.update(
														accumModel,
														{
															topicsById: A2(_elm_lang$core$Dict$remove, dataManipulation.key, accumModel.topicsById)
														});
												}
											case 'pin':
												var _p22 = dataManipulation.value;
												if (_p22.ctor === 'Just') {
													var _p23 = A2(_elm_lang$core$Json_Decode$decodeValue, _elm_lang$core$Json_Decode$string, _p22._0);
													if (_p23.ctor === 'Ok') {
														var _p33 = _p23._0;
														var _p24 = A2(_elm_lang$core$String$split, '|', dataManipulation.key);
														if (((_p24.ctor === '::') && (_p24._1.ctor === '::')) && (_p24._1._1.ctor === '[]')) {
															var _p32 = _p24._0;
															var _p31 = _p24._1._0;
															var _p25 = function () {
																var _p26 = A2(_elm_lang$core$Dict$get, _p33, accumModel.timeSlotRoomsByTopicId);
																if (_p26.ctor === 'Just') {
																	var _p29 = _p26._0;
																	var _p27 = A2(
																	...
																	if (_p27.ctor === 'Just') {
																		...
																		return {
																			ctor: '_Tuple2',
																			_0: A3(_elm_lang$core$Dict$insert, _p29, _p28, accumModel.topicIdsByTimeSlotRoom),
																			_1: A2(_elm_lang$core$Dict$remove, _p28, accumModel.timeSlotRoomsByTopicId)
																		};
																	} else {
																		return {
																			ctor: '_Tuple2',
																			_0: A2(_elm_lang$core$Dict$remove, _p29, accumModel.topicIdsByTimeSlotRoom),
																			_1: accumModel.timeSlotRoomsByTopicId
																		};
																	}
																} else {
																	var _p30 = A2(
																	...
																	if (_p30.ctor === 'Just') {
																		return {
																			ctor: '_Tuple2',
																			_0: accumModel.topicIdsByTimeSlotRoom,
																			_1: A2(_elm_lang$core$Dict$remove, _p30._0, accumModel.timeSlotRoomsByTopicId)
																		};
																	} else {
																		return {ctor: '_Tuple2', _0: accumModel.topicIdsByTimeSlotRoom, _1: accumModel.timeSlotRoomsByTopicId};
																	}
																}
															}();
															var unpinnedTopicIdsByTimeSlotRoom = _p25._0;
															var displacedTimeSlotRoomsByTopicId = _p25._1;
															return _elm_lang$core$Native_Utils.update(
																accumModel,
																{
			...
			case 'ShowAddTopicViewRequest':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							workingTopic: _elm_lang$core$Maybe$Just(
								{
									ctor: '_Tuple3',
									_0: _elm_lang$core$Maybe$Just(
										{ctor: '_Tuple2', _0: _p1._0, _1: _p1._1}),
									_1: 'new',
									_2: A2(_WinterTechForum$open_spaces_board$Board$Topic, '', '')
								})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ShowEditTopicViewRequest':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							workingTopic: _elm_lang$core$Maybe$Just(
								{ctor: '_Tuple3', _0: _elm_lang$core$Maybe$Nothing, _1: _p1._0, _2: _p1._1})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
						...
						if (_p38.ctor === 'Just') {
							...
							return A2(
								...
								A2(
									...
									A2(_elm_lang$core$Dict$get, _p39, model.timeSlotRoomsByTopicId))) ? _elm_lang$core$Platform_Cmd$none : A2(
														...
														_1: {
															...
															_1: {
																...
																_0: {
																	ctor: '_Tuple2',
																	_0: 'value',
																	_1: _elm_lang$core$Json_Encode$string(_p39)
																},
																_1: {ctor: '[]'}
															}
														}
																	...
																	_1: {
																		...
																		_1: {
																			...
																			_0: {
																				ctor: '_Tuple2',
																				_0: 'value',
																				_1: _elm_lang$core$Json_Encode$string(_p46)
																			},
																			_1: {ctor: '[]'}
																		}
																	}
																				...
																				_1: _elm_lang$core$Json_Encode$object(
																					{
																						...
																						_0: {
																							ctor: '_Tuple2',
																							_0: 'text',
																							_1: _elm_lang$core$Json_Encode$string(_p45.text)
																						},
																						_1: {
																							ctor: '::',
																							_0: {
																								ctor: '_Tuple2',
																								_0: 'convener',
																								_1: _elm_lang$core$Json_Encode$string(_p45.convener)
																							},
																							_1: {ctor: '[]'}
																						}
																					})
...
var _WinterTechForum$open_spaces_board$Board$DeleteTopicRequest = function (a) {
	return {ctor: 'DeleteTopicRequest', _0: a};
};
...
var _WinterTechForum$open_spaces_board$Board$DeleteWorkingTopic = {ctor: 'DeleteWorkingTopic'};
...
var _WinterTechForum$open_spaces_board$Board$UpdateWorkingTopicText = function (a) {
	return {ctor: 'UpdateWorkingTopicText', _0: a};
};
var _WinterTechForum$open_spaces_board$Board$ShowEditTopicViewRequest = F2(
	function (a, b) {
		return {ctor: 'ShowEditTopicViewRequest', _0: a, _1: b};
	});
var _WinterTechForum$open_spaces_board$Board$topicView = F2(
	function (topicId, topic) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id(topicId),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_0: _WinterTechForum$open_spaces_board$Board$onDragStart(
								_WinterTechForum$open_spaces_board$Board$SelectTopicToMove(topicId)),
							_1: {ctor: '[]'}
						}
					}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(topic.text),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(_elm_lang$core$Basics_ops['++'], 'Convener: ', topic.convener)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_0: _elm_lang$html$Html_Events$onClick(
									A2(_WinterTechForum$open_spaces_board$Board$ShowEditTopicViewRequest, topicId, topic)),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_WinterTechForum$open_spaces_board$Board$DeleteTopicRequest(topicId)),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_WinterTechForum$open_spaces_board$Board$UpdateWorkingTopicText),
								_1: {
									ctor: '::',
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(_p48.text),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Convener:'),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(_p48.convener),
											_1: {
												ctor: '::',
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_WinterTechForum$open_spaces_board$Board$CreateTopicRequest),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_WinterTechForum$open_spaces_board$Board$DeleteWorkingTopic),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_1: A2(
									...
									_elm_lang$core$Set$toList(model.rooms))
							}),
						_1: A2(
							_elm_lang$core$List$map,
							function (timeSlot) {
								return A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(timeSlot),
												_1: {ctor: '[]'}
											}),
										_1: A2(
											_elm_lang$core$List$map,
											function (room) {
												return A2(
															...
															_0: function () {
																var isDestinationCandidate = A2(
																	...
																	A2(
																		...
																		function (_p49) {
																			var _p50 = _p49;
																			return _elm_lang$core$Native_Utils.eq(_p50._0, timeSlot) && _elm_lang$core$Native_Utils.eq(_p50._1, room);
																		},
													...
													function () {
														...
														var _p51 = maybeTopicWithId;
														if (_p51.ctor === 'Just') {
															return {
																ctor: '::',
																_0: A2(_WinterTechForum$open_spaces_board$Board$topicView, _p51._0._0, _p51._0._1),
																_1: {ctor: '[]'}
															};
														} else {
															return {
																...
																_0: A2(
																	_elm_lang$html$Html$button,
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onClick(
																			A2(_WinterTechForum$open_spaces_board$Board$ShowAddTopicViewRequest, timeSlot, room)),
																		_1: {ctor: '[]'}
																	},
																	{
																		ctor: '::',
							...
							_elm_lang$core$Set$toList(model.timeSlots))
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Unpinned topics'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('unpinned'),
								_1: {ctor: '[]'}
							},
							A2(
								_elm_lang$core$List$filterMap,
								function (topicId) {
									return A2(
										_elm_lang$core$Maybe$map,
										_WinterTechForum$open_spaces_board$Board$topicView(topicId),
										A2(_elm_lang$core$Dict$get, topicId, model.topicsById));
								},
								_elm_lang$core$Set$toList(
									A2(
										...
										_elm_lang$core$Set$fromList(
											_elm_lang$core$Dict$keys(model.topicsById)),
										_elm_lang$core$Set$fromList(
						...
						_1: {
							...
							_0: A3(
								...
								'script',
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$src('https://bernardo-castilho.github.io/DragDropTouch/DragDropTouch.js'),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
...
var _WinterTechForum$open_spaces_board$Board$WebSocketMessage = function (a) {
...
var Elm = {};
Elm['Board'] = Elm['Board'] || {};
if (typeof _WinterTechForum$open_spaces_board$Board$main !== 'undefined') {
    _WinterTechForum$open_spaces_board$Board$main(Elm['Board'], 'Board', undefined);
}
