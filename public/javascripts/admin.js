...
var _WinterTechForum$open_spaces_board$Admin$DataManipulation = F3(
	function (a, b, c) {
		return {type_: a, operation: b, key: c};
	});
var _WinterTechForum$open_spaces_board$Admin$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {webSocketUrl: a, rooms: b, newRoom: c, newRoomValid: d, timeSlots: e, newTimeSlot: f, newTimeSlotValid: g};
	});
...
var _WinterTechForum$open_spaces_board$Admin$dataManipulationDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_WinterTechForum$open_spaces_board$Admin$DataManipulation,
	...
	A2(
		...
		function (opCode) {
			var _p0 = opCode;
			if (_p0 === '+') {
				return _WinterTechForum$open_spaces_board$Admin$Add;
			} else {
				return _WinterTechForum$open_spaces_board$Admin$Remove;
			}
		},
...
var _WinterTechForum$open_spaces_board$Admin$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'WebSocketMessage':
				var dataManipulationsRes = A2(
					...
					_elm_lang$core$Json_Decode$list(_WinterTechForum$open_spaces_board$Admin$dataManipulationDecoder),
					_p1._0);
				return {
					ctor: '_Tuple2',
					_0: function () {
			...
			case 'UpdatedNewRoom':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							newRoom: _p7,
							newRoomValid: !(_elm_lang$core$Native_Utils.eq(_p7, '') || A2(_elm_lang$core$String$contains, '|', _p7))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AddRoomRequest':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{newRoom: '', newRoomValid: false}),
					_1: (!model.newRoomValid) ? _elm_lang$core$Platform_Cmd$none : A2(
			...
			case 'UpdatedNewTimeSlot':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							newTimeSlot: _p8,
							newTimeSlotValid: !(_elm_lang$core$Native_Utils.eq(_p8, '') || A2(_elm_lang$core$String$contains, '|', _p8))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AddTimeSlotRequest':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{newTimeSlot: ''}),
					_1: (!model.newTimeSlotValid) ? _elm_lang$core$Platform_Cmd$none : A2(
						_elm_lang$websocket$WebSocket$send,
						model.webSocketUrl,
						A2(
							_elm_lang$core$Json_Encode$encode,
...
var _WinterTechForum$open_spaces_board$Admin$RemoveTimeSlotRequest = function (a) {
	return {ctor: 'RemoveTimeSlotRequest', _0: a};
};
var _WinterTechForum$open_spaces_board$Admin$AddTimeSlotRequest = {ctor: 'AddTimeSlotRequest'};
var _WinterTechForum$open_spaces_board$Admin$UpdatedNewTimeSlot = function (a) {
	return {ctor: 'UpdatedNewTimeSlot', _0: a};
};
var _WinterTechForum$open_spaces_board$Admin$RemoveRoomRequest = function (a) {
	return {ctor: 'RemoveRoomRequest', _0: a};
};
var _WinterTechForum$open_spaces_board$Admin$AddRoomRequest = {ctor: 'AddRoomRequest'};
var _WinterTechForum$open_spaces_board$Admin$UpdatedNewRoom = function (a) {
	return {ctor: 'UpdatedNewRoom', _0: a};
};
var _WinterTechForum$open_spaces_board$Admin$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
													...
													_0: A2(
														_elm_lang$html$Html$button,
														{
															...
															_0: _elm_lang$html$Html_Events$onClick(
																_WinterTechForum$open_spaces_board$Admin$RemoveRoomRequest(room)),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$value(model.newRoom),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(_WinterTechForum$open_spaces_board$Admin$UpdatedNewRoom),
															_1: {ctor: '[]'}
														}
													}
												},
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_WinterTechForum$open_spaces_board$Admin$AddRoomRequest),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$disabled(!model.newRoomValid),
															_1: {ctor: '[]'}
														}
													},
													{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Time Slots'),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$ul,
													...
													_1: {
														...
														_0: A2(
															_elm_lang$html$Html$button,
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(
																	_WinterTechForum$open_spaces_board$Admin$RemoveTimeSlotRequest(timeSlot)),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													_elm_lang$html$Html$input,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$value(model.newTimeSlot),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onInput(_WinterTechForum$open_spaces_board$Admin$UpdatedNewTimeSlot),
																_1: {ctor: '[]'}
															}
														}
													},
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(_WinterTechForum$open_spaces_board$Admin$AddTimeSlotRequest),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$disabled(!model.newTimeSlotValid),
																_1: {ctor: '[]'}
															}
														},
														{
...
var _WinterTechForum$open_spaces_board$Admin$WebSocketMessage = function (a) {
...
var Elm = {};
Elm['Admin'] = Elm['Admin'] || {};
if (typeof _WinterTechForum$open_spaces_board$Admin$main !== 'undefined') {
    _WinterTechForum$open_spaces_board$Admin$main(Elm['Admin'], 'Admin', undefined);
}
