...
if (typeof _WinterTechForum$open_spaces_board$Admin$main !== 'undefined') {
    _WinterTechForum$open_spaces_board$Admin$main(Elm['Admin'], 'Admin', {"types":{"unions":{"Admin.Msg":{"args":[],"tags":{"UpdatedNewTimeSlot":["String"],"UpdatedNewRoom":["String"],"WebSocketMessage":["String"],"AddTimeSlotRequest":[],"AddRoomRequest":[],"RemoveRoomRequest":["String"],"RemoveTimeSlotRequest":["String"]}}},"aliases":{},"message":"Admin.Msg"},"versions":{"elm":"0.18.0"}});
}
